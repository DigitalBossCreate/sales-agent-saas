...
// Función centralizada para obtener productos activos desde Supabase
...
// Función para registrar o actualizar clientes en el CRM
export async function gestionarCliente(userId, userName, userUsername) {
  try {
    ...
    console.error('Error en CRM cliente:', err);
    return null;
  }
}
